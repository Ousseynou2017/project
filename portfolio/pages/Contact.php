  ...
  <body>
    ...
    <main>
      <div class="Contact-1">
        ...
        <p>
          Travaillon ensemble! N'hesitez pas a me contacter pour discuter de vos
          projets ou collaboration.
        </p>
        <div class="icon">
          <div class="icon-info">
          ...
          <div class="icon-info">
            ...
            <div>
              ...
              <div>Keur Massar,Cite Penitence</div>
            </div>
          </div>
        </div>
      </div>
      <div class="Contact-2">
        ...
        <form method="post" action="submit.php">
          <div class="Contact-input">
            <input class="input" type="nom" placeholder="Nom complet" />
            ...
            />
            <input class="input" type="email" placeholder="Email subject" />
          </div>
          <textarea placeholder="your message" cols="70" rows="10"></textarea>
          <br />
